...
public class MenuTest {
    @DisplayName("메뉴 이름을 주어졌을 때 메뉴를 반환하는 메서드를 테스트한다.")
    @Test
    public void testGetMenuValidName() {
        Menu menu = Menu.getMenu("아이스크림");
        assertEquals(Menu.ICE_CREAM, menu);
    }

    @DisplayName("잘못된 메뉴 이름이 주어졌을 때 null을 반환하는 메서드를 테스트한다.")
    @Test
    public void testGetMenuInvalidName() {
        Menu menu = Menu.getMenu("건빵");
        assertNull(menu);
    }

    @DisplayName("메뉴 이름으로 toString 처리되게 하는 메서드를 테스트한다.")
    @Test
    ...
    @DisplayName("메뉴 종류를 반환하는 메서드를 테스트한다.")
    @Test
    ...
    @DisplayName("메뉴 가격을 반환하는 메서드를 테스트한다.")
    @Test
    ...
    @DisplayName("메뉴 이름을 반환하는 메서드를 테스트한다.")
    @Test
