...
- [x] 사용자의 입력을 받는다.
- [예외] 입력 값이 없으면 안된다.
  - [x] 방문 날짜를 입력 받는다. - InputView#readVisitDay()
  - [예외] 방문할 날짜는 1 이상 31 이하의 숫자로만 입력 받는다.
  - [x] 주문할 메뉴와 개수를 입력 받는다. - InputView#readOrderDetails()
...
- [x] 사용자에게 처리된 값을 출력한다.
- [예외] 출력 순서는 자유롭게 출력한다.
  - [x] 사용자에게 입력을 요청하는 문구를 출력한다. - XmasEventController#getDateAndOrder()
  - [x] 주문한 메뉴를 출력한다. - XmasEventController#printOrderDetails()
  - [x] 할인 전 총주문 금액을 출력한다. - XmasEventController#printTotalPurchaseAmount()
  - [x] 증정 메뉴를 출력한다. - XmasEventController#printTotalPurchaseAmount()
  - [x] 혜택 내역을 출력한다. - XmasEventController#printEachDiscountAmount()
  - [x] 총혜택 금액을 출력한다. - XmasEventController#printTotalDiscountAmount()
  - [x] 할인 후 예상 결제 금액을 출력한다. - XmasEventController#printEstimatePurchaseAmount()
  - [x] 12월 이벤트 배지를 출력한다. - XmasEventController#printEventBadge()

### 💻 도메인 기능

- [x] 방문 날짜와 메뉴 선택에 따른 총혜택을 계산한다. - DiscountCasher#getTotalDiscountAmount()
